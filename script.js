...
//QR QR QR QR QR QR QR QR QR RQ QR QR QR QR QR 
        ...
        startContainer.appendChild(qrBtn);*/
...
function openDivContentInNewTab() {
    updateQr();
  const qrContainerBox = document.getElementById('qrContainer').innerHTML;
